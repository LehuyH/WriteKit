<template>
  <div>
    <section class="hero is-link is-fullheight" style="background-color: #00cec9">
      <div class="hero-body">
    ...
    <div class="my-6 container has-text-centered">
        ...
        <div class="columns">
            <section class="column">
                ...
                <strong>Define</strong> what you want to write then get powerful <strong>tooling</strong> as you write!
            </section>
             <section class="column">
                Make writing more approachable with WriteKit's block system.
                <strong>Define</strong> what you want to write then get powerful <strong>tooling</strong> as you write!
...
.tilt-in-right-2 {
	-webkit-animation: tilt-in-right-2 0.6s cubic-bezier(0.250, 0.460, 0.450, 0.940) 1s both;
	        animation: tilt-in-right-2 0.6s cubic-bezier(0.250, 0.460, 0.450, 0.940) 1s both;
}
